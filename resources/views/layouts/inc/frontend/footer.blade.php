<div>
        <div class="footer-area">
            <div class="container">
                <div class="row">
                    <div class="col-md-3">
                        <h4 class="footer-heading">BloomsMe</h4>
                        <div class="footer-underline"></div>
                        <p>
                            New fashions are upcoming through BloomsMe stay tuned...!
                        </p>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="mb-2">
                            <p>
                                <i class="fa fa-map-marker"></i> #123, Kandy, sri lanka - 123456
                            </p>
                        </div>
                        <div class="mb-2">
                            <a href="" class="text-white">
                                <i class="fa fa-phone"></i> +94 769856581
                            </a>
                        </div>
                        <div class="mb-2">
                            <a href="" class="text-white">
                                <i class="fa fa-envelope"></i> bloomsme@gmail.com
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="copyright-area">
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        <p class=""> &copy; 2023 - BloomsMe. All rights reserved.</p>
                    </div>
                    <div class="col-md-4">
