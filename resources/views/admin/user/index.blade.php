                    ...
                    <tbody>
                        @forelse ($users as $user)
                         <tr>
                            ...
                            <a href="{{url('admin/users/'.$user->id.'/delete')}}" onClick="return confirm('Are you sure, you want to delete this product?')" class="btn btn-sm btn-danger">Delete</a>
                            </td>
                        </tr>
                        @empty
                        <tr>
                            <td colspan="5">No Users Available
